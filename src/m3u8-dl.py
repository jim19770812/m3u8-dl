...
from src import M3u8Downloader
import sys
import argparse
from M3u8Downloader import M3u8Downloader, M3u8Context  # noqa
...
def main():
    ...
    parser.add_argument("-H", "--headers", action='append',
                        help="[0]request headers，可以传多个值，用逗号隔开")
    ...
    parser.add_argument("-o", "--output", nargs="?", default='output.mp4', help="[0]file for saving [e.g.: example.mp4]")  # noqa
